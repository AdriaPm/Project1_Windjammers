#ifndef __RIGHT_ENGLISH_PLAYER_H__
#define __RIGHT_ENGLISH_PLAYER_H__
...
class RightEnglishPlayer : public Module
{
public:
	// Constructor
	RightEnglishPlayer(bool startEnabled);
...
#endif //!__RIGHT_ENGLISH_PLAYER_H__
